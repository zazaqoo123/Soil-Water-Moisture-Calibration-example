...
write.csv(OzNet_Y, "C:/USYD_SoilMoisture_Calibration/Soil Prob calibration project/USYD_Calibration_2023/OzNet/Yanco/OzNet_Y.csv", row.names = FALSE)
...
StretchPars3 <- list.files(path="F:/USYD_SoilMoisture_Calibration/Soil Prob calibration project/USYD_Calibration_2023/CSIRO90m", pattern =".tif", full.names=TRUE)
...
#Merge SLGA Bucketbounds
SoilBucket_Y <- read.csv("C:/USYD_SoilMoisture_Calibration/Soil Prob calibration project/USYD_Calibration_2023/OzNet/Yanco/SoilBucket_Y.csv")
OzNet_Y <- left_join(
  OzNet_Y, SoilBucket_Y %>% 
    dplyr::select(Site_ID, Sensor, SLGA_DUL1_O, SLGA_DUL1_N, SLGA_DUL2_O, SLGA_DUL2_N, SLGA_PWP1_O, SLGA_PWP1_N, SLGA_PWP2_O, SLGA_PWP2_N) %>%
    rename(DUL1_O = SLGA_DUL1_O, DUL1_N = SLGA_DUL1_N, DUL2_O = SLGA_DUL2_O, DUL2_N = SLGA_DUL2_N, PWP1_O = SLGA_PWP1_O, PWP1_N = SLGA_PWP1_N, PWP2_O = SLGA_PWP2_O, PWP2_N = SLGA_PWP2_N),
  by = c("Site_ID", "Sensor")
)
...
write.csv(LNormOBSPRED, "C:/USYD_SoilMoisture_Calibration/Soil Prob calibration project/USYD_Calibration_2023/OZnet/Yanco/OzNet_Yanco_calibrated2.csv", row.names = FALSE)
